...
thumbnailUrl: "/image/dev/white-nextjs.png"
author: ""
---

## Links to dev-resource

[Timothy Lin - superbloggen](https://www.timlrx.com/blog)
(https://tailwind-nextjs-starter-blog.vercel.app/)

posts/new-features-in-v1.mdx
...
To make generating a table of contents (TOC) simple, you can use the existing `` component.

For example, the TOC in this post was generated with the following code:

```jsx
< toc={props.toc} exclude="Overview" toHeading={2} />
```
...
```jsx
<h1 title="Like what you are reading?" />
```

< title="Like what you are reading?" />
